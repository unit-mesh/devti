...
class KotlinCodeProcessorTest {
    ...
    fun should_split_methods() {
        ...
        val newCode = """{"repo_name":"romannurik/muzei","path":"source-gallery/src/main/java/com/google/android/apps/muzei/gallery/ChosenPhotoDao.kt","copies":"2","size":"11222","content": $sourceCode,"license":"apache-2.0"}"""
...
internal abstract class ChosenPhotoDao {
    ...
    fun split_by_multiple_methods() {
        val newCode = """{"repo_name":"jamieadkins95/Roach","path":"database/src/main/java/com/jamieadkins/gwent/database/CardDao.kt","copies":"1","size":"1647","content":$multipleMethodSource,"license":"apache-2.0"}"""
        dump = RawDump.fromString(newCode)
        unitContext = CodeSnippetContext.createUnitContext(dump.toCode())
